...
const DateTimeSelector = ({ openHours }) => {
        ...
        <Stack spacing={2} direction="column">
            ...
            <Box sx={{ display: "flex", gap: 3, pt: 2, justifyContent: "center" }}>
                ...
                >
                    ...
                    {startDate ? dayjs(startDate).format("YYYY-MM-DD") : "시작일자"}
                </Button>
                <Button
                    variant="outlined"
                    sx={{
            ...
            <Dialog open={dateDialog.open} onClose={handleCloseDateDialog}>
                <DialogTitle sx={{ bgcolor: "#FFF7EF" }}>
                    {dateDialog.target === "start" ? "시작일 선택" : "종료일 선택"}
                </DialogTitle>
        ...
        <Box>
            ...
            <Box sx={{ pl: 3, pr: 3, pb: 3 }}>
                ...
                <Box sx={{ display: userWantReserve ? "block" : "none" }}>
                    ...
                    <Divider />
                    <Box sx={{ mb: 2 }}>
                        <DateTimeSelector openHours={detail.openHours} />
                    </Box>
                    <Divider />
                    <Box
                        sx={{ display: "flex", flexDirection: "column", justifyContent: "space-between", mt: 2, mb: 2 }}
                    >
                        <Box>
